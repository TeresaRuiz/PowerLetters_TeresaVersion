...
const SAVE_FORM = document.getElementById('saveForm'),
    ID_CLAS = document.getElementById('idClas'),
    NOMBRE_CLAS = document.getElementById('clasificacion'),
    DESCRIPCION_CLAS = document.getElementById('descripcion');
...
SAVE_FORM.addEventListener('submit', async (event) => {
    ...
    (ID_CLAS.value) ? action = 'updateRow' : action = 'createRow';
    // Constante tipo objeto con los datos del formulario.
...
const openCreate = () => {
    ...
    DESCRIPCION_CLAS.disabled = false;
}
